...
document.getElementById("repeatAsIs")?.addEventListener("click", ()=>{
  modal.classList.add("hidden");
  document.getElementById("repeatWeekBtn").click();
});
document.getElementById("repeatTweak")?.addEventListener("click", ()=>{
  modal.classList.add("hidden");
  alert("Small tweaks coming next (flavor / sides).");
});
