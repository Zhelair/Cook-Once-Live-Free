...
function getAllergyState(){
  return {
    fish: document.getElementById("allergyFish")?.value || "none",
    nuts: document.getElementById("allergyNuts")?.value || "none",
    dairy: document.getElementById("allergyDairy")?.value || "none",
    eggs: document.getElementById("allergyEggs")?.value || "none",
  };
}
function getPrefs(){
  return {
...
document.querySelectorAll("[data-nopork]").forEach(b=>{
  b.addEventListener("click", ()=>{
    noPork = b.getAttribute("data-nopork")==="1";
    document.querySelectorAll("[data-nopork]").forEach(x=>x.classList.remove("active","primary"));
    b.classList.add("active","primary");
  });
});
document.querySelectorAll("[data-noveal]").forEach(b=>{
  b.addEventListener("click", ()=>{
    noVeal = b.getAttribute("data-noveal")==="1";
    document.querySelectorAll("[data-noveal]").forEach(x=>x.classList.remove("active","primary"));
    b.classList.add("active","primary");
  });
});
...
document.addEventListener("DOMContentLoaded", initAutopilotUI);
